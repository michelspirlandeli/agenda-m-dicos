        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Data Emissão" required name="dataemissao">
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
         ...
         <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Data Exp. CNH"  name="expedicaocnh">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <label for="validadecnh">Data Val. CNH</label>
                    <input type="text" class="form-control" placeholder="Data Val. CNH"  name="validadecnh">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Dat. Exp. Cart. Prof." name="expedicaocarteira">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Dat. Emissão Tit. Eleitor" name="emissaotitulo">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Dt. Cadast. PIS"  name="datapis">
                </div>
            </div>
        </div>
       ...
       <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Número"  name="dataadmissao">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
