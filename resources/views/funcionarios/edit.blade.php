        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Data Emissão" required name="dataemissao" value="{{$funcionarios->dataemissao}}">
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="exameadmissao">Exame Admissão</label>
                     <select class="form-control" name="exameadmissao" value="{{$funcionarios->exameadmissao}}">
                        ...
                        <option {{($doctors->exameadmissao == 'Não' ? 'selected' : '')}}>Não</option>
                    </select>
