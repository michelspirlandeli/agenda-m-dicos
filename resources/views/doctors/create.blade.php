        		...
        		<div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="crm" required name="crm">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" placeholder="" required name="datanasc">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            ...
                            <select name="contratacao" id="uf" class="form-control" required>
                                <option>Selecione</option>
                                <option value="1">CLT</option>
                                <option value="2">Profissional Liberal</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" placeholder="" required name="datainicio">
                        </div>
                    </div>
                </div>
