                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" placeholder="" required name="dataconsulta" value="{{$agendamentos->dataconsulta}}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="horario">Horario da Consulta</label>
                            <input type="time" class="form-control" placeholder="" required name="horario" value="{{$agendamentos->horario}}">
                        </div>
                    </div>
                </div>
                <div class="row">
