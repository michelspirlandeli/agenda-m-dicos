        ...
        <div class="row">
            <div class="col-md-10">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Digite o nome do paciente" name="paciente" required>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="médico" required name="medico">
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
